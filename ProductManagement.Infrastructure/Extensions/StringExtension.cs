...
namespace ProductManagement.Infrastructure.Extensions
{
    public static class StringExtension
    {
        ...
        {
            DateTime.TryParse(value, out var longValue);

            if (longValue == DateTime.MinValue)
                return null;
        ...
        public static string GetExtention(this string file)
        {
        ...
        public static string ToFullLikeText(this string value)
        {
            return $"%{value}%";
        }
    }
